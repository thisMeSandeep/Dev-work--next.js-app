...
import { Category, Speciality, ExperienceLevel } from "@/generated/prisma";
    ...
    return (
        <section className="p-4">
            ...
            <div className="flex items-center flex-wrap gap-8">
                ...
                {profiles.map((dev) => (
                    <Card key={dev.id} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 shadow-none rounded-sm border ">

...
const selectStyles = "w-full border-green-300 focus-visible:border-green-500 focus-visible:ring-2 focus-visible:ring-green-500/20 focus-visible:outline-none";
...
const DeveloperProfileForm = ({ onSuccess }: Props) => {
  ...
  const defaultValues = {
    available: user?.FreelancerProfile?.available ?? true,
    country: user?.country ?? "",
    mobile: user?.FreelancerProfile?.mobile ?? null,
    bio: user?.FreelancerProfile?.bio ?? null,
    skills: user?.FreelancerProfile?.skills ?? [],
    category: user?.FreelancerProfile?.category ?? undefined,
    speciality: user?.FreelancerProfile?.speciality ?? undefined,
    experienceLevel: user?.FreelancerProfile?.experienceLevel ?? undefined,
    perHourRate: user?.FreelancerProfile?.perHourRate ?? null,
    languages: user?.FreelancerProfile?.languages ?? null,
    portfolioLink: user?.FreelancerProfile?.portfolioLink ?? null,
    otherLink: user?.FreelancerProfile?.otherLink ?? null,
    file: null,
